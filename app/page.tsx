...
export default function Home() {
  return (
    ...
    <div className="flex flex-col items-center justify-center px-6 py-12 w-full">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">Welcome to the OnCall App</h1>
          <p className="text-lg text-gray-400 mt-4">This is the home page of the OnCall app.</p>
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-4 mt-8 flex items-center">
